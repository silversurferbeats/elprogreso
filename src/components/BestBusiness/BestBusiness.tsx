      ...
      <div className="flex flex-col gap-4">
        <div className="w-full md:h-[18rem] flex flex-col md:flex-row p-4 bg-[#005046] rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 ease-in-out">
          <img
            ...
            alt="Card Image"
            src="/assets/TablaImg.jpg"
          />
          <div className="flex flex-col justify-center aligth-center text-center p-4 gap-8">
            <h2 className="text-2xl text-white font-semibold">
              Picada Doble Premium
            </h2>
            <p className="text-white px-4">
              2 pan de campo + 2 bandejas Queso pulina, Salame, Lomo ahumado,
              Jamon Cocido, Queso Roque fort, Longaniza, Cantimpalo, Mortadela
              Calcha, Primavera, Bondiola, Pepinillos, Olivas rellenas, Olivas
              Negras, Cebollin.
            </p>
